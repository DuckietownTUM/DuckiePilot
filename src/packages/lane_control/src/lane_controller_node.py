...
class LaneControllerNode(DTROS):
    ...
    def __init__(self, node_name):
        ...
        self.vehicle_name = rospy.get_param("~vehicle_name", os.environ.get("VEHICLE_NAME", "duckmobile"))
        self.sub_centres = rospy.Subscriber(
            f"/{self.vehicle_name}/vehicle_detection_node/centers",
            VehicleCorners,
        ...
        # LED control
        rospy.wait_for_service(f"/{self.vehicle_name}/led_emitter_node/set_pattern")
        self.led_svc = rospy.ServiceProxy(
            f"/{self.vehicle_name}/led_emitter_node/set_pattern", ChangePattern,
        )
